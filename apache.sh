...
clear
printf "=======================================================================\n"
printf "Install Apache for LTANMP  ,  Written xiaohuai.org \n"
printf "=======================================================================\n"
printf "LTANMP is a tool to auto-compile & install Tengine+Nginx+MySQL+PHP on Linux \n"
printf "This script is a tool to install Apache for ltanmp \n"
printf "\n"
...
if [ -s httpd-2.4.4.tar.gz ]; then
  echo "httpd-2.4.4.tar.gz [found]"
  else
  echo "Error: httpd-2.4.4.tar.gz not found!!!download now......"
  wget -c http://www.ltanmp.com/ltanmp/httpd-2.4.4.tar.gz
fi
...
if [ -s mod_rpaf-0.6.tar.gz ]; then
  ...
  wget -c http://www.ltanmp.com/ltanmp/mod_rpaf-0.6.tar.gz
fi
...
if [ -s php-5.2.17.tar.gz ]; then
  ...
  wget -c http://www.ltanmp.com/ltanmp/php-5.2.17.tar.gz
fi
...
sed -i 's/#ServerName www.example.com:80/ServerName www.ltanmp.com:88/g' /usr/local/apache/conf/httpd.conf
...
sed -i 's/disable_functions =.*/disable_functions = phpinfo,passthru,exec,system,chroot,scandir,chgrp,chown,shell_exec,popen,pclose,proc_open,proc_close,proc_nice,proc_terminate,leak,proc_get_status,ini_alter,ini_set,ini_restore,dl,openlog,syslog,readlink,symlink,pcntl_exec,popepassthru,stream_socket_server,putenv,posix_getpwuid,pfsockopen,psockopen,php_u,crack_closedictescap,crack_getlastmessage,fsocket,crack_opendict,eshellcmd/g' /usr/local/php/etc/php.ini
...
wget -c http://www.ltanmp.com/ltanmp/init.d.httpd
...
printf "====================== Upgrade to LTANMP completed =====================\n"
printf "You have successfully upgrade from ltanmp ,enjoy it!\n"
printf "=======================================================================\n"
printf "LTANMP is a tool to auto-compile & install Tengine+Nginx+MySQL+PHP on Linux \n"
printf "This script is a tool to upgrade from ltanmp to ltanmp \n"
printf "\n"
printf "For more information please visit http://www.ltanmp.com \n"
printf "=======================================================================\n"