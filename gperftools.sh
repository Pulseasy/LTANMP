...
clear
echo "========================================================================="
echo "Google Perf Tools Installation for LTANMP Written xiaohuai.org"
echo "========================================================================="
...
wget http://www.ltanmp.com/ltanmp/libunwind-1.1.tar.gz
...
echo "========================================================================="
echo "Install gperftools for LTANMP  ,  Written xiaohuai.org"
echo "========================================================================="
echo "LTANMP is a tool to auto-compile & install Tengine+Nginx+MySQL+PHP on Linux"
echo "For more information please visit http://www.ltanmp.com"
echo "========================================================================="