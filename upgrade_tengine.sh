...
clear
echo "========================================================================="
echo "Upgrade Nginx for LTANMP,  Written by xiaohuai"
echo "========================================================================="
...
./configure --user=www --group=www --prefix=/usr/local/nginx --with-http_stub_status_module --with-http_ssl_module --with-http_gzip_static_module --with-ipv6 --with-http_sysguard_module --with-http_concat_module --with-http_upstream_check_module --with-google_perftools_module
make && make install
