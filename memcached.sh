...
clear
printf "=======================================================================\n"
printf "Install Memcached for LTANMP  ,  Written xiaohuai.org \n"
printf "=======================================================================\n"
printf "LTANMP is a tool to auto-compile & install Tengine+Nginx+MySQL+PHP on Linux \n"
printf "This script is a tool to install memcached for ltanmp \n"
printf "\n"
...
wget -c http://www.ltanmp.com/ltanmp/memcache-3.0.6.tgz
...
wget -c http://www.ltanmp.com/ltanmp/libevent-2.0.21-stable.tar.gz
...
wget -c http://www.ltanmp.com/ltanmp/memcached-1.4.15.tar.gz
