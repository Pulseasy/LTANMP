...
clear
printf "=========================================================================\n"
printf "Pureftpd for LTANMP  ,  Written by XiaoHuai \n"
printf "=========================================================================\n"
...
wget -c http://www.ltanmp.com/ltanmp/pure-ftpd-1.0.36.tar.gz
fi
...
wget -c http://www.ltanmp.com/ltanmp/ftp_v2.1.tar.gz
fi
...
wget -c http://www.ltanmp.com/ltanmp/init.d.pureftpd
...
printf "=======================================================================\n"
printf "Install Pure-FTPd for LTANMP  ,  Written by XiaoHuai \n"
printf "=======================================================================\n"
printf "LTANMP is a tool to auto-compile & install Tengine+Nginx+MySQL+PHP on Linux \n"
