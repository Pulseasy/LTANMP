...
clear
echo "========================================================================="
echo "Upgrade phpMyAdmin for LTANMP,  Written by xiaohuai"
echo "========================================================================="
...
sed -i 's/STARITWCOM/xiaohuai.org'$RANDOM'xiaohuai.com/g' /home/www/default/phpmyadmin/config.inc.php
