...
clear
printf "=======================================================================\n"
printf "Install PHP5.* for LTANMP  ,  Written xiaohuai.org \n"
printf "=======================================================================\n"
printf "LTANMP is a tool to auto-compile & install Tengine+Nginx+MySQL+PHP on Linux \n"
printf "This script is a tool to install PHP5.* for ltanmp \n"
printf "\n"
...
if [ -s autoconf-2.13.tar.gz ]; then
  ...
  wget -c http://www.ltanmp.com/ltanmp/autoconf-2.13.tar.gz
fi
...
if [ -s php-5.2.17-fpm-0.5.14.diff.gz ]; then
  ...
  wget -c http://www.ltanmp.com/ltanmp/php-5.2.17-fpm-0.5.14.diff.gz
fi
...
cd php-5.2.17/
wget -c http://www.ltanmp.com/ltanmp/php-5.2.17-max-input-vars.patch
...
if cat /etc/issue | grep -Eqi '(Debian|Ubuntu)';then
    cd ext/openssl/
    wget -c http://www.ltanmp.com/ltanmp/debian_patches_disable_SSLv2_for_openssl_1_0_0.patch
...
sed -i 's/disable_functions =.*/disable_functions = phpinfo,passthru,exec,system,chroot,scandir,chgrp,chown,shell_exec,popen,pclose,proc_open,proc_close,proc_nice,proc_terminate,leak,proc_get_status,ini_alter,ini_set,ini_restore,dl,openlog,syslog,readlink,symlink,pcntl_exec,popepassthru,stream_socket_server,putenv,posix_getpwuid,pfsockopen,psockopen,php_u,crack_closedictescap,crack_getlastmessage,fsocket,crack_opendict,eshellcmd/g' /usr/local/php$ver1/etc/php.ini

if [ `getconf WORD_BIT` = '32' ] && [ `getconf LONG_BIT` = '64' ] ; then
    wget -c http://www.ltanmp.com/ltanmp/ZendOptimizer-3.3.9-linux-glibc23-x86_64.tar.gz
    tar zxvf ZendOptimizer-3.3.9-linux-glibc23-x86_64.tar.gz
	mkdir -p /usr/local/zend/
	cp ZendOptimizer-3.3.9-linux-glibc23-x86_64/data/5_2_x_comp/ZendOptimizer.so /usr/local/zend/
else
    wget -c http://www.ltanmp.com/ltanmp/ZendOptimizer-3.3.9-linux-glibc23-i386.tar.gz
...
wget -c http://www.ltanmp.com/ltanmp/php-fpm.conf
cp php-fpm.conf /usr/local/php52/etc/php-fpm.conf

/usr/local/php52/sbin/php-fpm start
wget -c http://www.ltanmp.com/ltanmp/init.d.php-fpm5.2
...
if [ `getconf WORD_BIT` = '32' ] && [ `getconf LONG_BIT` = '64' ] ; then
	if echo $php_version | grep -q "5.3.*";then
		wget -c http://www.ltanmp.com/ltanmp/ZendGuardLoader-php-5.3-linux-glibc23-x86_64.tar.gz
		...
		wget -c http://www.ltanmp.com/ltanmp/ZendGuardLoader-70429-PHP-5.4-linux-glibc23-x86_64.tar.gz
	...
	if echo $php_version | grep -q "5.3.*";then
		wget -c http://www.ltanmp.com/ltanmp/ZendGuardLoader-php-5.3-linux-glibc23-i386.tar.gz
		...
		wget -c http://www.ltanmp.com/ltanmp/ZendGuardLoader-70429-PHP-5.4-linux-glibc23-i386.tar.gz
...
printf "=======================================================================\n"
printf "LTANMP is a tool to auto-compile & install Tengine+Nginx+MySQL+PHP on Linux \n"
printf "This script is a tool to install PHP5.*  for ltannmp \n"
printf "\n"
printf "For more information please visit http://www.ltanmp.com \n"
printf "=======================================================================\n"
