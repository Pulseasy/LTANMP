...
clear
printf "=======================================================================\n"
printf "Install eAcesselerator for LTANMP  ,  Written by xiaohuai \n"
printf "=======================================================================\n"
printf "LTANMP is a tool to auto-compile & install Tengine+Nginx+MySQL+PHP on Linux \n"
printf "This script is a tool to install eAccelerator for ltanmp \n"
printf "\n"
...
wget -c http://www.ltanmp.com/ltanmp/eaccelerator-0.9.5.3.tar.bz2
fi
...
wget -c http://www.ltanmp.com/ltanmp/eaccelerator-0.9.6.1.tar.bz2
fi
...
wget -c http://www.ltanmp.com/ltanmp/eaccelerator-eaccelerator-42067ac.tar.gz
fi
...
printf "=======================================================================\n"
printf "LTANMP is a tool to auto-compile & install Tengine+Nginx+MySQL+PHP on Linux \n"
printf "This script is a tool to install $ver0  for ltanmp \n"
printf "\n"
printf "For more information please visit http://www.ltanmp.com \n"
printf "=======================================================================\n"
