...
clear
echo "========================================================================="
echo "Install ImageMagick for LTANMP,  Written xiaohuai.org"
echo "========================================================================="
...
if [ -s ImageMagick-6.7.1-6.tar.gz ]; then
  ...
  wget -c http://www.ltanmp.com/ltanmp/ImageMagick-6.7.1-6.tar.gz
  if [ $? -eq 0 ]; then
...
if [ -s imagick-3.0.1.tgz ]; then
  ...
  wget -c http://www.ltanmp.com/ltanmp/imagick-3.0.1.tgz
  if [ $? -eq 0 ]; then
