...
clear
echo "========================================================================="
echo "Add Virtual Host for LTANMP  ,  Written by xiaohuai "
echo "========================================================================="
echo "LTANMP is a tool to auto-compile & install Tengine+MySQL+PHP+Apache on Linux "
